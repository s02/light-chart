...
type ADParams = InferStudyValues<typeof AD_SCHEMA.inputs> & InferStudyValues<typeof AD_SCHEMA.style>
...
export class AdvanceDecline extends AbstractIndicator implements Indicator {
  ...
  constructor(chart: IChartApi, datafeed: Datafeed, options: IndicatorOptions) {
    ...
    this.#chart = chart
    this.#params = resolveStudyParams(AD_SCHEMA.inputs, AD_SCHEMA.style, options?.params)
  ...
  setParams(params: StudyParams) {
    this.#params = resolveStudyParams(AD_SCHEMA.inputs, AD_SCHEMA.style, params)
    this.#series.line.applyOptions({ color: this.#params.color })
  }
